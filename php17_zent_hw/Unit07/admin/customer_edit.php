<?php 
    ...
    $id = $_GET['code'];
	$sql = "SELECT * FROM customers WHERE code='".$id."'";
    ...
    <hr>
        <form action="customer_edit_process.php" method="POST" role="form" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="Mã khách hàng" name="code" value="<?= $data['code']?>" readonly >
            </div>
            <div class="form-group">
                <label for="">Tên khách hàng</label>
                <input type="text" class="form-control" id="" placeholder="Nhập vào tên khách hàng" name="name" value="<?= $data['name']?>">
            </div>  
            <div class="form-group">
