...
<div class="container-fluid">
  ...
  <h1>EMPLOYEES</h1>
  <hr>
  <a href="employee_add.php" class="btn btn-primary">Add new employee</a>
  <?php 
            ...
            <tr>
              ...
              <td  style="text-align: center;">
               <a  class="btn btn-success btn-detail" data-id="<?= $row['code']?>">Detail</a>  
                <a href="employee_edit.php?code=<?php echo $row['code']; ?>" class="btn btn-warning">Update</a>  
                <a href="employee_delete.php?code=<?php echo $row['code']; ?>" class="btn btn-danger">Delete</a>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h2 class="modal-title">Thông tin nhân viên</h2>
  ...
  $(document).ready(function(){
    $(".btn-detail").click(function(){
        var code = $(this).attr("data-id");
         $.ajax({
          type: "GET",
          url: "employee_detail.php?code="+code,
          data:{
